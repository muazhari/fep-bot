...
import { COMMAND_PREFIX, BATCH_LIST, SharedProps } from "../../Bot";
...
export const Twibbon = (Bot) => {
  ...
  const twibbon_list = [
    {
      ...
      url:
        "https://res.cloudinary.com/fep-bot/image/upload/v1585597597/twibbons/twibbon_covid.png",
    ...
    },
    {
      ...
      url:
        "https://res.cloudinary.com/fep-bot/image/upload/v1564639746/twibbons/twibbon_cs.png",
      transform: (filename, size) => {
        return {
          auto: {
            transformation: [
    ...
    },
    {
      ...
      url:
        "https://res.cloudinary.com/fep-bot/image/upload/v1585599615/twibbons/twibbon_tfi.png",
      transform: (filename, size) => {
        return {
          auto: {
            transformation: [
    ...
    },
    {
      ...
      name: "Binus 1",
      url:
        "https://res.cloudinary.com/fep-bot/image/upload/v1565372081/twibbons/twibbon_binus1.png",
      transform: (filename, size) => {
        return {
          auto: {
            transformation: [
    ...
    },
    {
      ...
      name: "Binus 2",
      url:
        "https://res.cloudinary.com/fep-bot/image/upload/v1585598545/twibbons/twibbon_binus2.png",
      transform: (filename, size) => {
        return {
          auto: {
            transformation: [
    ...
    },
    {
      ...
      name: "Binus 3",
      url:
        "https://res.cloudinary.com/fep-bot/image/upload/v1585598544/twibbons/twibbon_binus3.png",
      transform: (filename, size) => {
        return {
          auto: {
            transformation: [
  ...
  const displayList = (category) => {
    let selected = twibbon_list.filter(
      (twibbon) => typeof twibbon.category === "string"
    );
  ...
  const listenPostback = (data) => {
    if (data.twibbon) {
      ...
      Bot.getProfile().then((profile) => {
        const messages = [
          `Hai ${profile.displayName}, masukin gambar mu disini ya!`,
        ];
  ...
  const getTransformedFileUrl = (twibbonSetting, publicId, filename, size) => {
    const getTwibbonById = twibbon_list.filter(
      (twibbon) => twibbon.id === twibbonSetting.id
    )[0];
    const result = cloudinary.url(
      publicId,
      getTwibbonById.transform(filename, size)[twibbonSetting.type]
    );
    return result;
  };
